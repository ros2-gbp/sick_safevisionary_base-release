...
%global pkg_name sick_safevisionary_base
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-sick-safevisionary-base
Version:        1.0.1
Release:        4%{?dist}
...
%description
The package provides the basic hardware interface to the SICK Safevisionary
sensor
...
%changelog
* Wed Apr 29 2026 Marvin Grosse Besselmann <grosse@fzi.de> - 1.0.1-4
- Autogenerated by Bloom

* Tue Apr 28 2026 Marvin Grosse Besselmann <grosse@fzi.de> - 1.0.1-3
- Autogenerated by Bloom

* Tue Apr 21 2026 Marvin Grosse Besselmann <grosse@fzi.de> - 1.0.1-2
- Autogenerated by Bloom
